...
export const handle: Handle = async ({ event, resolve }) => {
  ...
  // Route protection - MUST happen BEFORE resolve()
  ...
  // Redirect logged in users away from auth pages (except for form actions)
  if (event.url.pathname.startsWith('/auth/') && event.locals.user && event.request.method === 'GET') {
